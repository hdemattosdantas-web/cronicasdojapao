-- Adicionar novas colunas para personagens aprimorados
...
ALTER TABLE characters ADD COLUMN IF NOT EXISTS strength INTEGER DEFAULT 10;
ALTER TABLE characters ADD COLUMN IF NOT EXISTS agility INTEGER DEFAULT 10;
ALTER TABLE characters ADD COLUMN IF NOT EXISTS intelligence INTEGER DEFAULT 10;
ALTER TABLE characters ADD COLUMN IF NOT EXISTS charisma INTEGER DEFAULT 10;

-- Adicionar coluna para data de nascimento (para cálculo automático de idade)
ALTER TABLE characters ADD COLUMN IF NOT EXISTS birth_date TIMESTAMP WITH TIME ZONE DEFAULT NOW();

-- Adicionar coluna para ativo/inativo (para múltiplos personagens)
